...
public class _02_AP_AlternativeSubArray {
    public static void main(String[] args) {
        System.out.println(new _02_AP_AlternativeSubArray().solve(new ArrayList<>(Arrays.asList(1, 0, 1, 0, 1)), 1));
        System.out.println(new _02_AP_AlternativeSubArray().solve(new ArrayList<>(Arrays.asList(0, 0, 0, 1, 1, 0, 1)), 1));
    }
